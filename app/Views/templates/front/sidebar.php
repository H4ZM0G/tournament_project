<div class="sidebar sidebar-dark sidebar-fixed border-end" id="sidebar">
    <div class="sidebar-header border-bottom">
        <div class="sidebar-brand">
            <a href="<?= base_url('/front'); ?>"><img src="<?= base_url('/assets/brand/PPTournamentSLAM.jpg'); ?>" class="sidebar-brand-full" _width="88"
                                                      height="32"
                                                      alt="Mon Projet" /></a>
            <a href="<?= base_url('/front'); ?>"><img src="<?= base_url('/assets/brand/PPTournamentSLAM.jpg'); ?>" class="sidebar-brand-narrow" _width="32"
                                                      height="32"
                                                      alt="Mon Projet" /></a>
            SLAM
        </div>
