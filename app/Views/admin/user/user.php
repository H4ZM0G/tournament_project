                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex justify-content-and align-items-center">
                        ...
                        if (isset($utilisateur) && $utilisateur['blacklistid_user'] == null) { ?>
                            ...
                            <a title="Désactiver l'utilisateur"
                               href="<?= base_url('admin/user/activateBlacklist/') . $utilisateur['id']; ?>">
                            ...
                            <a title="Activer un utilisateur"
                               href="<?= base_url('admin/user/deactivateBlacklist/') . $utilisateur['blacklistid_user']; ?>">
                        ...
                        <div class="tab-pane active" id="profil" role="tabpanel" aria-labelledby="profil-tab"
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="id_permission" name="id_permission">
                                    <option disabled <?= !isset($utilisateur) ? "selected" : ""; ?> >Selectionner un
                                        role
                                    </option>
