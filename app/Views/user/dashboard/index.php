<div class="container mt-5">
    <header class="mb-5">
        <h1 class="text-center">SLAM User</h1>
    </header>
        ...
        <div class="col-md-4">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <p class="card-text">Inscrivez vous à un tournois</p>
                    <a href="/user/tournament" class="btn btn-primary">S'inscrire</a>
                </div>
            </div>
        </div>
        <!-- School Card -->
        <div class="col-md-4">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <a href="/admin/school" class="btn btn-primary">Voir les écoles</a>
                </div>
            </div>
        </div>
        <!-- Game Card -->
        <div class="col-md-4">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <a href="/admin/game" class="btn btn-primary">Voir les jeux</a>
                </div>
            </div>
        </div>
    </div>
