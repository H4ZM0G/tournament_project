...
class AddSchoolCategorySlug extends Migration
{
    public function up()
    {
        ...
        // TableUserPermission
        $this->forge->addColumn('school_category', [
            'slug' => [
                'type'       => 'VARCHAR',
                'constraint' => '100',
                'unique'     => true,
        ...
        $this->updateSlugs('school_category');
    }

    public function down()
    {
        $this->forge->dropColumn('school_category', 'slug');
    }
